...
for (let i = 0; i < data.length; i++) {
    ...
    for (let j = 0; j < string.length; j++) {
        ...
        if (string[j].charCodeAt() >= 48 && string[j].charCodeAt() <= 57) {
            ...
            switch (string[j]) {
                case "o":
                    if ("o" + string[j + 1] + string[j + 2] === "one") {
                        is = true;
                ...
                case "t":
                    if ("t" + string[j + 1] + string[j + 2] === "two") {
                        pair += 2;
                        is = true;
                ...
                case "f":
                    if (
                        "f" + string[j + 1] + string[j + 2] + string[j + 3] ===
                        "four"
                    ) {
                        is = true;
                ...
                case "s":
                    if ("s" + string[j + 1] + string[j + 2] === "six") {
                        is = true;
                ...
                case "n":
                    if (
                        "n" + string[j + 1] + string[j + 2] + string[j + 3] ===
                        "nine"
                    ) {
                        is = true;
                        pair += 9;
    ...
    for (let j = string.length - 1; j >= 0; j--) {
        ...
        if (string[j].charCodeAt() >= 48 && string[j].charCodeAt() <= 57) {
            ...
            switch (string[j]) {
                case "e":
                    if ("e" + string[j - 1] + string[j - 2] === "eno") {
                        is = true;
                        pair += 1;
                        break;
                    }
                ...
                case "o":
                    if ("o" + string[j - 1] + string[j - 2] === "owt") {
                        is = true;
                ...
                case "r":
                    if (
                        "r" + string[j - 1] + string[j - 2] + string[j - 3] ===
                        "ruof"
                    ) {
                        pair += 4;
                        is = true;
                ...
                case "e":
                    if (
                        "e" + string[j - 1] + string[j - 2] + string[j - 3] ===
                        "evif"
                    ) {
                        pair += 5;
                        is = true;
                ...
                case "x":
                    if ("x" + string[j - 1] + string[j - 2] === "xis") {
                        pair += 6;
                        is = true;
                        break;
                    }
